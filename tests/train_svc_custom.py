...
# -*- coding: utf-8 -*-
"""
Script específico para entrenar modelos SVC (Support Vector Classifier).
...
BASE_MODELS_ROOT = os.path.join(PROJECT_ROOT, "output", "models", "custom_svc")
BASE_LOGS_ROOT   = os.path.join(PROJECT_ROOT, "output", "logs", "custom_svc")
...
def run_training():
    logger.info("=== INICIANDO ENTRENAMIENTO CUSTOM SVC (DUAL CONFIG) ===")
    ...
    for config in CONFIGS_TO_RUN:
        ...
        grids = config["GRIDS"] # Reading GRIDS dict
        ...
        for mode in MODES:
            ...
            for i, params in enumerate(combos):
                # Optimization: Skip redundant gamma for linear kernel
                ...
                if tpr < 0.10: continue # Hard constraint relaxed for importance analysis
    ...
    logger.info("=== FIN ENTRENAMIENTO SVC ===")
